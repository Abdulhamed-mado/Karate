...
"
            ...
            Dim com As New SqlCommand("insert into ref values('" + txt1.Text + "' , '" + txt2.Text + "' , '" + txt3.Text + "' , '" + txt4.Text + "' , '" + s + "' , '" + txt5.Text + "' , '" + "0" + "' , '" + ss + "' , '" + sa + "' , '" + ss + "' , '" + "0" + "')", myconn)
...
"
            ...
            Dim myconn As New SqlConnection(str)
            Dim com As New SqlCommand("delete FROM ref WHERE  ID='" + txt1.Text + "'", myconn)
            Try
                myconn.Open()
            ...
            Catch ex As Exception
                MsgBox("الرجاء التأكد من حذف جميع سجلات الخاصة بدرجات الحكم", MsgBoxStyle.Exclamation, "خطأ")
...
"
    ...
    Private Sub Form4_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'KarateDataSet28.ref' table. You can move, or remove it, as needed.
        Me.RefTableAdapter.Fill(Me.KarateDataSet28.ref)
...
"
        ...
        Dim myconn As New SqlConnection(str)
        Dim com As New SqlCommand("SELECT * FROM ref WHERE  ID='" + s + "'", myconn)
        ...
        Catch ex As Exception
            MsgBox("الرجاء التأكد من نقر المزدوج على خانة رقم الحكم", MsgBoxStyle.Exclamation, "خطأ")
